...
public class ItemSorcerousSword extends ItemSwordBase {
    public ItemSorcerousSword(String name) {
            ...
            if (!worldIn.isRemote) {
                ...
                if (itemDamage != 0) {
                    ...
                    if (cost <= currentPlayerFood) {
                        ...
                        playerIn.sendMessage(SimpleSorceryUtils.sorceryMessage("You must eat more food to repair this sword!"));
                    }
                }
            }
        }
