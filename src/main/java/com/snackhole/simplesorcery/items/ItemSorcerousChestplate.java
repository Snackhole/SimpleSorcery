...
public class ItemSorcerousChestplate extends ItemArmorBase {
    public ItemSorcerousChestplate(String name) {
        super(SimpleSorceryMain.sorcerousArmorMaterial, EntityEquipmentSlot.CHEST, name);
    }
            ...
            if (!worldIn.isRemote) {
                ...
                if (itemDamage != 0) {
                    ...
                    if (cost <= currentPlayerFood) {
                        ...
                        playerIn.sendMessage(SimpleSorceryUtils.sorceryMessage("You must eat more food to repair this chestplate!"));
                    }
                }
            }
