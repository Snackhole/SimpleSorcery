...
public class ItemSorcerousBoots extends ItemArmorBase {
    public ItemSorcerousBoots(String name) {
        super(SimpleSorceryMain.sorcerousArmorMaterial, EntityEquipmentSlot.FEET, name);
    }
            ...
            if (!worldIn.isRemote) {
                ...
                if (itemDamage != 0) {
                    ...
                    if (cost <= currentPlayerFood) {
                        ...
                        playerIn.sendMessage(SimpleSorceryUtils.sorceryMessage("You must eat more food to repair these boots!"));
                    }
                }
            }
