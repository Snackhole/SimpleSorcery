...
public class hunger implements ISpell {
    @Override
    public void cast(int level, EntityPlayerMP player, boolean entityDetected, int entityID) {
        if (entityDetected) {
            ...
            if (target.isEntityAlive()) {
                ...
                targetLiving.addPotionEffect(new PotionEffect(Potion.getPotionById(17), SimpleSorceryUtils.getTicksFromSeconds(10 * level)));
