...
import com.simplesorcery.items.ItemStaffOfSorcery;
import com.simplesorcery.sorcery.spells.*;
...
public class Spellcasting {
    ...
    public void castSpell(String spellName, boolean entityDetected, int entityID, MessageContext ctx) {
        // Get Player
        EntityPlayerMP player = (EntityPlayerMP) proxy.getPlayerEntityFromContext(ctx);
