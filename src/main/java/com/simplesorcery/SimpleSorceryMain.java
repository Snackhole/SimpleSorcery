package com.simplesorcery;

import com.simplesorcery.commands.CommandSorcery;
import com.simplesorcery.gui.SorceryGuiHandler;
import com.simplesorcery.items.ModItems;
import com.simplesorcery.network.PacketHandler;
import com.simplesorcery.proxy.IProxy;
import com.simplesorcery.sorcery.*;
...
public class SimpleSorceryMain {
    ...
    @SidedProxy(clientSide = "com.simplesorcery.proxy.ClientProxy", serverSide = "com.simplesorcery.proxy.ServerProxy")
